...
setHTMLElemAttribute('href', 'https://anstice.com', 'info_button', false);
...
operateAnimation('PLAY', 'Anstice_Armature', 0, 75, 'LoopRepeat', 1,
        function() {}, false);


registerOnClick('Anstice_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'Anstice_Armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hi.mp3'), false);

  operateAnimation('PLAY', 'Anstice_Armature', 80, 199, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'Anstice_group'], false);
      ...
      changeVis(['scale_percentage', 'ready_button', 'drag_move', 'drag_rotate', 'drag_scale'], false);
      setObjTransform('Anstice_Armature', false, 'scale', [1, 1, 1], false);
      updateTextObj('scale_percentage', '100%');
    }, function() {
      changeVis(['GROUP', 'Anstice_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('Anstice_Armature', false, 'position', createVector(0, 0, 0), false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('Anstice_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'Anstice.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'Anstice_group'], true);
  setObjTransform('Anstice_Armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('Anstice_Armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('Anstice_Armature', 'XY', 'WORLD', 'r)k@!/YDHP@yq;j_ep/e', '}hME)N9mk:?IQ@H9yk{I');
}, function() {}, '}hME)N9mk:?IQ@H9yk{I');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('Anstice_Armature', 'Z', 'WORLD', '$F7c^epCm$g^WE/,G{]F', '+5sLJA8=yOG[#1_1B_]:');
}, function() {}, '+5sLJA8=yOG[#1_1B_]:');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('Anstice_Armature', 'Z', 'A-y5g?`NC(lFaNPx#?6Y', 'CWam!NhaoX/P1[=nQWD$');
  dragScale('Anstice_Armature', 'X', '~SByv_u|gdS*!;m%u.w}', 'CWam!NhaoX/P1[=nQWD$');
  dragScale('Anstice_Armature', 'Y', '6J|bI-hTJbCy*eC9nZlp', 'CWam!NhaoX/P1[=nQWD$');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('Anstice_Armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'CWam!NhaoX/P1[=nQWD$');
